...
namespace System.Web.Mvc.Html
{
    ...
    public static class MvcExtensions
    {
        ...
        /// <returns></returns>
        public static string AuthorityCommandForCheckboxHtmlTags(this HtmlHelper htmlHelper,
            string name,
            string className,
            long selected = 1,
        ...
        /// <param name="selected"></param>
        /// <returns></returns>
        public static string AuthorityCommandForSpanHtmlTags(this HtmlHelper htmlHelper, string name, string className, long selected = 1)
        {
            ReloadWebAuthorityCommands();
            StringBuilder str = new StringBuilder();
